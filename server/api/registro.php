...
/**
 * Envía el correo de "Pre-registro recibido" para registros NORMALES
 * (no waitlist). Confirma al jugador que su pre-registro entró y
 * lista los datos capturados. No incluye banner de lista de espera.
 * Best-effort: errores se loguean y no rompen el flujo de inserción.
 */
...
/**
 * Envía el correo de confirmación cuando el jugador adjunta su
 * comprobante de pago vía /registro/comprobante (registro_publico.php).
 * Confirma que el comprobante llegó y que el comité validará el pago.
 */
