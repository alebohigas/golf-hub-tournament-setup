-- =====================================================================
-- Seed: /skinrules content for torneoid=360
...
--
-- IMPORTANT: este seed es SOLO para torneoid=360. Otros torneos deben
...
-- ---------------------------------------------------------------------
INSERT INTO convocatoria_content (torneoid, section_id, section_type, content, enabled) VALUES (360, 'skinrules_pdf_label', 'text', '{"label": "Ver Reglas del Skin Game (PDF)"}', 1)
ON DUPLICATE KEY UPDATE
  section_type = VALUES(section_type),
  content = VALUES(content),
  enabled = 1,
