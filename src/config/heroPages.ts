...
export const HERO_PAGES: HeroPageDef[] = [
  ...
  { path: '/competencias', label: 'Competición', aiPrompt: 'Hoyo par 3 sobre el agua en hora dorada con bandera' },
  ...
  { path: '/skin', label: 'Skin Game', aiPrompt: 'Pelota cayendo en el hoyo en hora dorada, ángulo dramático' },
