 ...
 * PremiosPostersSection / AvisosPostersSection / AtraccionesSection so
 * admins get a consistent editorial workflow: drop images into
 * `src/assets/hoteles/` (build-time fallback) or upload them through
 * Admin > Hoteles (server-side, takes precedence), then tune column
