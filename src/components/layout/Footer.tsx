import { tournamentInfo, tournamentStats } from '@/data/mockData';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary-foreground/70">Club Campestre Torreón</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <span className="text-2xl font-display font-bold text-secondary">{tournamentStats.holes}</span>
